...
class Modal extends Component {
    ...
    createTask = e => {
        ...
        const data = {
            product: this.props.products.product._id,
    ...
    render() {
        ...
        // Create task modal
        if (this.props.task) {
            const { teamMembers } = this.props.products.product;
            ...
            return (
                <form onSubmit={this.createTask} className="modal">
                    ...
                    <div>
                        <button className="main-btn update-product" type="submit">
                            Create Task
            </button>
                    </div>
                </form>
        ...
        // Edit Task Modal
            ...
            return (
                <form className="modal">
                    ...
                    <div>
                        <button
                            className="main-btn update-product"
                            type="button"
                        ...
                        <button
                            className="main-btn delete-product"
        ...
        // Edit product modal
            ...
            return (
                <div className="modal">
                    ...
                    <h1 className="header">Edit Product Info</h1>
                    <p className="created-by">
                        Created by {this.props.owner.name} ({this.props.owner.email})
          </p>
                    <div className="form-group">
                        <label>
                            <div className="form-label">Product Name (required)</div>
                            <input
                                onChange={this.onChange}
                    ...
                    <div>
                        <button
                            className="main-btn update-product"
                            onClick={this.updateProduct.bind(this, this.props.id)}
                        >
                            Update Product
            </button>
                        {this.props.owner.id === this.props.auth.user.id ? (
                            <button
                                className="main-btn delete-product"
                                onClick={this.deleteProduct.bind(this, this.props.id)}
                            >
                                Delete Product
              </button>
                        ) : null}
        ...
        // Create product modal
            ...
            return (
                <div className="modal">
                    ...
                    <div>
                        <button
                            className="main-btn create-product"
